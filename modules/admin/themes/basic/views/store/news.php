			...
			<div class="row">
				<div class="col-xs-12">
                    ...
                    ?>
						<table id="sample-table-1" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row['news_status']? yii::t('app', '启用'): yii::t('app', '禁用');?></td>
                                    <td>
                                        <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                        
                                            <?php if($can['edit']):?>
                                            <a href="#" id="<?php echo $row['news_id'];?>" class="edit btn btn-xs btn-info" title="<?php echo yii::t('app', '编辑');?>">
                                            ...
                                            <?php if($can['delete']):?>
                                            <a href="#" class="btn btn-xs btn-warning delete" id="<?php echo $row['news_id'];?>" title="<?php echo yii::t('app', '删除');?>">
                                        ...
                                        <div class="visible-xs visible-sm hidden-md hidden-lg">
                                            <div class="inline position-relative">
                                                ...
                                                <ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
                                                    ...
                                                    <?php if($can['edit']):?>
                                                    <li>
                                                        <a href="#" id="<?php echo $row['news_id'];?>" class="edit tooltip-info" data-rel="tooltip" title="<?php echo yii::t('app', '编辑');?>">
                                                            <span class="green">
                                                    ...
                                                    <?php if($can['delete']):?>
                                                    <li>
                                                        <a href="#" class="tooltip-info delete" id="<?php echo $row['news_id'];?>" data-rel="tooltip" title="<?php echo yii::t('app', '删除');?>">
                                                            <span class="red">
                                                                <i class="ace-icon fa fa-trash-o bigger-120"></i>
                                                            </span>
                                                        </a>
                        ...
                        <div class="center">
                            <?php if($can['add']):?>
                            <a href="<?php echo Url::to('/admin/store/newsadd');?>" class="btn btn-xs">
...
<!-- 编辑 -->
 <?php 
	$form = ActiveForm::begin([
		'action'=> Url::to('/admin/store/newsedit'),
		'method'=>'post',
		'enableClientValidation'=>false,
		'enableClientScript'=>false,
	]);
	        ...
	        buttons: [
	            {
	                ...
	                "id" : "danger",
	                click: function() {
	                    location.href="<?php echo Url::to("/admin/store/newsdelete");?>"+"?id="+$a;
	                    $( this ).dialog( "close" );
	                }
	            }
	            ,
