        ...
        <div class="page-header">
            <h1>
                ...
                <small style="cursor:pointer">
                        ...
                        <a href="<?php echo Url::to("/admin/user/user")?>"><?php echo yii::t('app', '用户列表')?></a>
                </small>
                <small>
                        <i class="ace-icon fa fa-angle-double-right"></i>
                        <?php echo yii::t('app', '编辑用户')?>
                </small>
            </h1>
        </div><!-- /.page-header -->
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-11">
				...
				<?php echo $form->field($model, 'user_status')->checkbox([
						'class'=>'ace ace-switch ace-switch-5',
						'name'=>'user_status','id'=>'id-button-borders',
