        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-11">
				...
				<div class="form-group">
					...
					<img src="<?php echo Yii::$app->params['img_url'].'/'.$model['store_logo'];?>" width="180" height="100"/>
				...
				<div class="form-group">
					...
					<img src="<?php echo Yii::$app->params['img_url'].'/'.$model['store_map'];?>" width="180" height="100"/>
					<div class="col-xs-12 col-sm-4">
